...
def registrar_prestamo(lista_libros, lista_estudiantes, lista_prestamos): #bueno agarramos las listas para usarlas aca ya que el prestamo se usa todo basciamente
    ...
    pedirlibro = input("Ingrese el codigo del libro: ").upper() #el upper esta para que el input cuente incluso si esta en min
    ...
    pedircarnet = input("Ingrese el carnet del estudiante: ").upper() #casi que la misma explicacion que la de los libros
